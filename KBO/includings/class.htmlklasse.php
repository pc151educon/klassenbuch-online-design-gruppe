...
class HtmlKlasse
{
    ...
    public function getKlassens()
    {
        ...
        foreach ($this->klassens as $klasse)
        {
            ...
            $html.= '	<tr>
        <td class="ungerade" width="100" height="10"><input type="text" name="klasse'.$klasse['klasse_id'].'" value="'.$klasse['name'].'"></td>
        <td colspan="2" class="ungerade" width="100" height="10"><input type="submit" name="deaktiv' .$klasse['klasse_id']. '" value="' .$submit_label. '"> <input type="submit" name="update" value="Update"></td>
    </tr>';
